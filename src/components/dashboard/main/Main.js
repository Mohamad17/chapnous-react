        ...
        <section className={isOpenSidebar?'flex flex-col gap-y-6 w-full md:w-4/5 lg:w-5/6 bg-zinc-200 dark:bg-dark-700 min-h-screen md:rounded-r-[50px] main-cotainer py-2 px-4 lg:p-6':'flex flex-col gap-y-6 bg-zinc-200 dark:bg-dark-700 min-h-screen md:rounded-r-[25px] myTransition py-2 px-4 lg:p-6 md:w-[95vw]'}>
            <div id="header" className='grid grid-cols-9 gap-y-3 items-center justify-between'>
                ...
                <div id='avatar' className='col-span-3 col-start-7 md:col-span-2 md:col-start-8 order-2 md:order-3 justify-self-end flex items-center gap-3'>
                    <section onClick={(e) => changeTheme(e)} className='flex items-center justify-center w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 text-sm lg:text-base border border-purple-500 bg-zinc-400 rounded-md text-white hover:bg-purple-400 hover:text-zinc-500 mytransition'>
                        {
                            darkMode?<FontAwesomeIcon icon={['fas', 'sun']} id='sun' />:<FontAwesomeIcon icon={['fas', 'moon']} id='moon' />
                        }
                    </section>
                    <section className='flex items-center justify-center w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 text-sm lg:text-base border border-purple-500 bg-zinc-400 rounded-md text-white hover:bg-purple-400 hover:text-zinc-500 mytransition'>
