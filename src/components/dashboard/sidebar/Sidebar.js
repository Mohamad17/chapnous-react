...
const Sidebar = () => {
    ...
    return (
        <section className={isOpenSidebar ? 'w-1/5 lg:w-1/6 h-[100vh] flex justify-end items-center relative' : 'sidbar-wrapp h-[100vh] flex justify-end items-center relative'}>
            {/* sidbar open start */}
            <div className={isOpenSidebar ?
                'overflow-auto sidebar text-sm lg:text-base bg-purple-600 text-white flex flex-col gap-y-2 h-[100vh] p-6 mytransition' :
                'overflow-auto sidebar text-sm lg:text-base bg-purple-600 text-white flex flex-col gap-y-2 h-[100vh] p-6 mytransition translate-x-56'}>
            ...
            <div className={isOpenSidebar ?
                'hidden' :
                'bg-purple-600 fixed z-[15000] overflow-auto sidebar text-white flex flex-col justify-between gap-y-4 h-[100vh] p-6 mytransition'}>
                <Link className='mt-6'>
                    <FontAwesomeIcon icon={['fas', 'home']} />
                </Link>
            ...
            {/* sidbar button start */}
            <div onClick={sidbarBtnHandler} className={isOpenSidebar ? "sidebarBtnOpen group" : "sidebarBtnClose group"}>
                <FontAwesomeIcon className={isOpenSidebar ? 'text-[8px] group-hover:text-base text-amber-200 mytransition' : 'rotate-180 text-[8px] group-hover:text-base text-amber-200 mytransition'} icon={['fas', 'angle-right']} />
            </div>
            {/* sidbar button end */}
            {/* vitreen modal menu start */}
            <section id='vitreen2' onMouseLeave={() => setShowSubMenu(false)} onMouseEnter={() => setShowSubMenu('vitreen')} className={showSubMenu === 'vitreen' ? 'absolute right-1/2 text-sm w-32 bg-purple-700 rounded-md shadow-md z-[15500] flex flex-col gap-y-1 mt-3 p-2' : 'hidden'}>
            ...
            <section id='orders2' onMouseLeave={() => setShowSubMenu(false)} onMouseEnter={() => setShowSubMenu('orders')} className={showSubMenu === 'orders' ? 'absolute right-1/2 text-sm w-32 bg-purple-700 rounded-md shadow-md z-[15500] flex flex-col gap-y-1 mt-3 p-2' : 'hidden'}>
            ...
            <section id='payments2' onMouseLeave={() => setShowSubMenu(false)} onMouseEnter={() => setShowSubMenu('payments')} className={showSubMenu === 'payments' ? 'absolute right-1/2 text-sm w-32 bg-purple-700 rounded-md shadow-md z-[15500] flex flex-col gap-y-1 mt-3 p-2' : 'hidden'}>
            ...
            <section id='discounts2' onMouseLeave={() => setShowSubMenu(false)} onMouseEnter={() => setShowSubMenu('discounts')} className={showSubMenu === 'discounts' ? 'absolute right-1/2 text-sm w-32 bg-purple-700 rounded-md shadow-md z-[15500] flex flex-col gap-y-1 mt-3 p-2' : 'hidden'}>
            ...
            <span id='delivery2' className={showSubMenu === 'delivery' ? 'absolute z-[15500] right-2/3 flex justify-center items-center text-sm text-white pb-1 w-32 bg-zinc-700 rounded-md' : 'hidden'}>روش های ارسال</span>
            {/* delivery modal menu end */}
            {/* content modal menu start */}
            <section id='content2' onMouseLeave={() => setShowSubMenu(false)} onMouseEnter={() => setShowSubMenu('content')} className={showSubMenu === 'content' ? 'absolute right-1/2 text-sm w-32 bg-purple-700 rounded-md shadow-md z-[15500] flex flex-col gap-y-1 mt-3 p-2' : 'hidden'}>
            ...
            <section id='users2' onMouseLeave={() => setShowSubMenu(false)} onMouseEnter={() => setShowSubMenu('users')} className={showSubMenu === 'users' ? 'absolute right-1/2 text-sm w-32 bg-purple-700 rounded-md shadow-md z-[15500] flex flex-col gap-y-1 mt-3 p-2' : 'hidden'}>
            ...
            <section id='tickets2' onMouseLeave={() => setShowSubMenu(false)} onMouseEnter={() => setShowSubMenu('tickets')} className={showSubMenu === 'tickets' ? 'absolute right-1/2 text-sm w-40 bg-purple-700 rounded-md shadow-md z-[15500] flex flex-col gap-y-1 mt-3 p-2' : 'hidden'}>
            ...
            <span id='email2' className={showSubMenu === 'email' ? 'absolute z-[15500] right-2/3 flex justify-center items-center text-sm text-white pb-1 w-32 bg-zinc-700 rounded-md' : 'hidden'}>اعلامیه ایمیلی</span>
            {/* email modal menu end */}
            {/* message modal menu start */}
            <span id='message2' className={showSubMenu === 'message' ? 'absolute z-[15500] right-2/3 flex justify-center items-center text-sm text-white pb-1 w-32 bg-zinc-700 rounded-md' : 'hidden'}>اعلامیه پیامکی</span>
            {/* message modal menu end */}
            {/* setting modal menu start */}
            <span id='setting2' className={showSubMenu === 'setting' ? 'absolute z-[15500] right-2/3 flex justify-center items-center text-sm text-white pb-1 w-32 bg-zinc-700 rounded-md' : 'hidden'}>تنظیمات</span>
