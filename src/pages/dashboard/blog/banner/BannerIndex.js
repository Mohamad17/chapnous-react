...
const BannerIndex = () => {
    return (
        <div className='flex flex-col items-center gap-y-4 px-4'>
            ...
            {/* breadcrumb end */}
            {/* head page start */}
            <p className='dark:text-zinc-300 text-xl md:text-2xl self-start'>بنر ها</p>
            <div className="flex flex-wrap justify-evenly md:justify-between items-center gap-y-4 w-full">
                <Link to='/dashboard/content/banners/create' className='squareIcon relative group'>
                    <FontAwesomeIcon icon={['fas', 'plus']} />
                    <span className='tooltip w-28 hidden group-hover:flex'>بنر جدید</span>
                </Link>
            ...
            <section className="container dark:text-zinc-200">
                ...
                <div className="hidden grid-cols-12 gap-4 p-4 text-sm md:grid title_color">
                    ...
                    <div className="col-span-3 text-center"> عنوان بنر </div>
                    <div className="col-span-3 text-center"> آدرس</div>
                    <div className="col-span-3 text-center"> جایگاه </div>
                ...
                <div className="flex flex-col gap-2">
                    <div className="relative grid grid-cols-1 gap-4 px-4 pt-4 pb-6 bg-white border rounded-lg dark:bg-dark-700 border-style md:grid-cols-12">
                        ...
                        <div className="flex items-center justify-between md:justify-center md:col-span-3">
                            <h3 className="text-sm md:hidden"> عنوان بنر </h3>
                            <h3 className="text-sm"> چاپ دیجیتال </h3>
                        </div>
                        <div className="flex items-center justify-between md:justify-center md:col-span-3">
                            <h3 className="text-sm md:hidden"> آدرس </h3>
                            <h3 className="text-sm"> banner/unified </h3>
                        </div>
                        <div className="flex items-center justify-between md:justify-center md:col-span-3">
                            <h3 className="text-sm md:hidden"> جایگاه </h3>
                            <h3 className="text-sm">بنر اصلی</h3>
                        </div>
                        ...
                        <div className="flex justify-center md:px-0 items-center gap-x-4 md:gap-x-2 md:gap-4 md:col-span-1">
                            <div className="text-2xl md:text-sm text-purple-700 dark:text-cyan-400 hover:text-cyan-800 dark:hover:text-purple-400 cursor-pointer relative group">
                                <Link to='/dashboard/content/banners/edit'>
