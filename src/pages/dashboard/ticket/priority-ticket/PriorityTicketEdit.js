    ...
    return (
        <div className='flex flex-col items-center gap-y-4 px-4'>
            ...
            <section className='flex items-center gap-x-2 self-start pb-2 border-b-2 border-purple-700 dark:border-cyan-300 dark:text-zinc-300 text-[10px] md:text-sm'>
                ...
                <p>ویرایش اولویت تیکت</p>
            </section>
            {/* breadcrumb end */}
            {/* head page start */}
            <p className='dark:text-zinc-300 text-xl md:text-2xl self-start'>ویرایش اولویت تیکت</p>
            {/* head page end */}
            {/* form start */}
...
export default PriorityTicketEdit;